...
<body>
	...
	<div class="y-us-section">
		<div class="container">
				...
				<div class="col-md-8 offset-md-2 col-sm-12 col-xs-12">
					<div class="y-us-head">
						<div class="y-us-title">
							<h2>Why choose us</h2>
							<p>We are working on to build new age educational solution for the future generation where they get quality education, 24x7 support, effortless learning and memorization while being affordable to everyone. </p>
			...
			<div class="row">
				<div class="col-md-4 col-sm-12 col-xs-12 scrollanimation slow-animated fadeInLeftBig">
							...
							<div class="service-box">
								<div class="clearfix">
									<div class="iconset">
										...
										<span class="fa fa-money-check icon icon1-left animate__pulse"></span>
									</div>
									<div class="y-us-content">
										<h4>Cost effective</h4>
										<p>We provide the best quality education at the most affordable price. Reduces your educational budget by 70%.</p>
									</div>
								</div>
							</div>
							<div class="service-box">
								<div class="clearfix">
									<div class="iconset">
										<div class="pulse1"></div>
										<span class="fa fa-user-graduate icon icon1-left animate__pulse"></span>
									</div>
									<div class="y-us-content">
										<h4>Expert guidance</h4>
										<p>We provide the learning with subject expert and recorded lectures, live lectures & conceptual doubt clarification session.</p>
									</div>
								</div>
							</div>
							<div class="service-box">
								<div class="clearfix">
									<div class="iconset">
										<div class="pulse1"></div>
										<span class="fa fa-book icon icon1-left animate__pulse"></span>
									</div>
									<div class="y-us-content">
										<h4>Interactive education</h4>
										<p>We provide interactive educational content. User can interact with any of object click, move and explore at will.</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-md-4 col-sm-6 col-xs-12 scrollanimation slow-animated fadeIn">
					<div class="why-choose-banner">
						<img src="images/home/char.png" alt="" width="100%">
					</div>
				</div>
				<div class="col-md-4 col-sm-12 col-xs-12 scrollanimation slow-animated fadeInRight">
					<div class="y-us-contentbox">
						<div class="service-3">
							<div class="service-box">
								<div class="clearfix">
									<div class="y-us-content text-right">
										<h4>24x7 support</h4>
										<p>With the help of our specialized AI, you get 24x7 educational support. You get instant solution with detailed explanation.</p>
									</div>
									<div class="iconset">
										<div class="pulse1"></div>
										<span class="fa fa-business-time icon animate__pulse"></span>
									</div>
								</div>
							</div>
							<div class="service-box">
								<div class="clearfix">
									<div class="y-us-content text-right">
										...
										<p>The AI identifies your learning pattern & provide customized solution based on that. It will keep you updated with your global progress.</p>
									</div>
									<div class="iconset">
										<div class="pulse1"></div>
										<span class="fa fa-chalkboard icon animate__pulse"></span>
									</div>
								</div>
							</div>
							<div class="service-box">
								<div class="clearfix">
									<div class="y-us-content text-right">
										<h4>Visual & gamified Learning</h4>
										<p>With the help of exciting games and animation you create visual learning and memorize the concepts and formulae effortlessly.</p>
									</div>
									<div class="iconset">
										<div class="pulse1"></div>
										<span class="fa fa-gamepad icon animate__pulse"></span>
									</div>
								</div>
							</div>
						</div>
    ...
    <div class="row ">
      <div class="col-md-4">
        <div class="card card1">
          <img class="card-img-top img-fluid img-raised img-thumbnail" src="images\home\brand.png" alt="Card image cap">
        </div>
      </div>
      <div class="col-md-8">
        <div class="card card1">
  ...
  <style>.card1{min-height:360px;}</style> -->
	...
	<!-- <section id="our-process" class="padding bgdark">
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12 text-center scrollanimation animated fadeInLeftBig">
					<div class="y-us-head">
						<div class="y-us-title">
							<h2>Work Process</h2>
							<span class="y-us-title-border"></span>
			...
			<div class="row">
				<ul class="process-wrapp">
					<li class="whitecolor scrollanimation animated fadeInLeftBig">
						<span class="pro-step bottom20">01</span>
						<p class="fontbold bottom20">Lorem Ipsum</p>
						<p class="mt-n2 mt-sm-0">Quisque tellus risus, adipisci viverra bibendum urna.</p>
					</li>
					<li class="whitecolor scrollanimation animated fadeInLeft">
					<li class="whitecolor scrollanimation animated fadeInLeft">
		...
		<div class="container">
			<div class="row justify-content-center mb-5">
				<div class="col-md-7 text-center heading-section heading-section-white">
					<span class="subheading">accusantium doloremque</span>
				</div>
			</div>
						...
						<div class="col-md-3 d-flex justify-content-center counter-wrap">
							<div class="block-18 text-center">
								<div class="text">
									...
									<span>accusantium doloremque</span>
								</div>
							</div>
						</div>
						<div class="col-md-3 d-flex justify-content-center counter-wrap">
	...
	<section class="ftco-section bg-white ftco-partner scrollanimation animated fadeInLeftBig">
		<div class="container">
			<div class="row">
				<div class="col-sm">
					<a href="#" class="partner"><img src="images\home\partner-1.png" class="img-fluid" alt="Colorlib Template"></a>
				</div>
				<div class="col-sm">
					<a href="#" class="partner"><img src="images\home\partner-2.png" class="img-fluid" alt="Colorlib Template"></a>
				</div>
				<div class="col-sm">
					<a href="#" class="partner"><img src="images\home\partner-3.png" class="img-fluid" alt="Colorlib Template"></a>
				</div>
				<div class="col-sm">
					<a href="#" class="partner"><img src="images\home\partner-4.png" class="img-fluid" alt="Colorlib Template"></a>
				</div>
				<div class="col-sm">
					<a href="#" class="partner"><img src="images\home\partner-5.png" class="img-fluid" alt="Colorlib Template"></a>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row mb-5 pb-5 align-items-center d-flex">
				<div class="col-md-6">
					<div class="heading-section heading-section-white">
						<span class="subheading">accusantium doloremque</span>
						<h2 style="font-size: 30px;">Sign Up For Alwion</h2>
					</div>
				</div>
				<div class="col-md-3">
					<!--
...
-->
				...
				<div class="col-md-3">
					<p class="mb-0"><a href="#" class="btn btn-primary py-3 px-4">Make A Donation</a></p>
				</div>
			</div>
			<div class="row mb-5">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4 bg-new p-4">
						<h2 class="ftco-heading-2">Alwion</h2>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4 ml-md-5">
						...
						<ul class="list-unstyled">
							<li><a href="#" class="py-2 d-block">Lorem Ipsum</a></li>
							<li><a href="#" class="py-2 d-block">Lorem Ipsum</a></li>
							<li><a href="#" class="py-2 d-block">Lorem Ipsum</a></li>
							<li><a href="#" class="py-2 d-block">Lorem Ipsum</a></li>
						</ul>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<ul class="list-unstyled">
							<li><a href="#" class="py-2 d-block">Lorem</a></li>
							<li><a href="#" class="py-2 d-block">Ipsum</a></li>
							<li><a href="#" class="py-2 d-block">Lorem</a></li>
							<li><a href="#" class="py-2 d-block">Ipsum</a></li>
						</ul>
					</div>
