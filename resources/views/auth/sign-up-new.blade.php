                ...
                <div id="cards">
                    ...
                    <div class="card" id="register">
                        <div class="box">
                            ...
                            <form action="formsubmit" method="POST" id="register-form">

                                <label>Email</label>
                                <input type="text" name="email" id="register-email" class="textbox"> <br>
                                @error('email')
                                <span style="color:red; padding-top:2px; padding-bottom:2px;">{{$message}}</span>
                                @enderror
                                <label>Password</label>
                                <input type="password" name="password" id="register-password" class="textbox"> <br>
                                @error('password')
                                <span style="color:red; padding-top:2px; padding-bottom:2px;">{{$message}}</span>
                                @enderror
                                <label>Confirm Password</label>
                                <input type="password" name="password2" id="register-password-conf" class="textbox"> <br>
                                @error('password2')
                                <span style="color:red; padding-top:2px; padding-bottom:2px;">{{$message}}</span>
                                @enderror
                                {{@csrf_field()}}
