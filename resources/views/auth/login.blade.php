...
<body class="sign-in" oncontextmenu="return false;" style="background-color:rgba(64, 183, 245);">
						...
						<div class="col-lg-6">
							<div class="cmp-info">
								<div class="cm-logo">
									...
									<h3 style="font-size: 37px; line-height: 2.1em; letter-spacing: 0px; margin-left: 70px;">Alwion</h3>
...
<!-- 
											...
											<li><a href="{{ route('social.oauth', 'google') }}" title="" class="tw"><i class="fa fa-google"></i>Login Via Google</a></li>
											<li><a href="{{ route('social.oauth', 'facebook') }}" title="" class="fb"><i class="fa fa-facebook"></i>Login Via Facebook</a></li>
										</ul>
									</div>
									<!--login-resources end-->
								</div>
