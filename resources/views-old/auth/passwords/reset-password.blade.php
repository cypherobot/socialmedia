                ...
                <div id="cards">
                    <div class="card" id="login">
                        <div class="box">
                            ...
                            <div class="mytitle">Reset password</div>
                        </div>
                        <form id="login-form">
                            ...
                            <input type="password" id="login-password-1" class="textbox">
                        </form>
                        <button type="submit" class="proceed">Change Your Password <i class="ion-ios-arrow-thin-right"></i></button>
                    </div>
