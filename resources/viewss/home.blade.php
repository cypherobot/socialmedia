				...
				<div class="post-project-fields">
					...
					@csrf
						<div class="row">
							...
							<div class="col-lg-10">
								<textarea name="description" id="emojionearea1" placeholder="Description"></textarea>
							</div>
							 <div style="padding:20px 10px 5px 10px;">
                        <span style="width:-webkit-fill-available;">
                            <input type="file" name="file[]" multiple="multiple" id="fileinput" accept="video/*,  video/x-m4v, video/webm, video/x-ms-wmv, video/x-msvideo, video/3gpp, video/flv, video/x-flv, video/mp4, video/quicktime, video/mpeg, video/ogv, .ts, .mkv, image/*, image/heic, image/heif"/>
							<img id="createimgloader" src="http://www.hiquik.in/extras/createimgloader.gif" style="width:145px;height:95px;display:none;">
							<textarea id="imgbasedata" name="imgbasedata" style="display:none;"></textarea>
                        </span>
